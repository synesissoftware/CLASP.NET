...
namespace Clasp.Exceptions
{
    ...
    /// <summary>
    ///  Thrown to indicate unused option(s)
    /// </summary>
    public class UnusedOptionException
        : UnusedFlagOrOptionException
    {
        ...
        /// </param>
        public UnusedOptionException(IArgument arg, FailureOptions failureOptions)
        ...
        ///  The failure options specified to the parse operation
        /// </param>
        public UnusedOptionException(IArgument arg, FailureOptions failureOptions, string message)
            : base(arg, message, failureOptions, ArgumentType.Option)
        {
        }
        #endregion
    }
